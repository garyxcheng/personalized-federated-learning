...
class PerAvgHF(Server):
    def __init__(self, dataset,datasetnumber,algorithm, model, batch_size, learning_rate, beta, lamda, num_glob_iters,
        ...
        for i in range(total_users):
            ...
            user = UserPerAvgHF(id, train, valid, test, model, batch_size, learning_rate, beta, lamda, local_epochs, optimizer ,total_users , num_users, beta_HF, delta_HF, device=device, dataset=dataset)
